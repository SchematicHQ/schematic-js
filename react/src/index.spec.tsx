...
describe("schematic-react", () => {
  ...
  // Re-exporting a value as `type X` still type-checks, and api-extractor
  // still rolls the value's declaration into the .d.ts — so the types promise
  // a runtime export the bundle does not carry, and the host finds out when
  // `InvoiceStatus.Paid` throws. Asserted here because tsc cannot see it.
