 ...
 * `@schematichq/schematic-components/elements`); this module only carries a host's
 ...
 * `useResolvedLocale` in schematic-components/elements instead, which resolves the
