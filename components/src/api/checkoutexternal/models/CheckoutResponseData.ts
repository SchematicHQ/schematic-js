 ...
 */
export function instanceOfCheckoutResponseData(
  value: object,
): value is CheckoutResponseData {
  if (
...
export function CheckoutResponseDataFromJSONTyped(
  json: any,
  ...
  return {
    ...
    confirmPaymentIntentClientSecret:
      json["confirm_payment_intent_client_secret"] == null
        ? undefined
        : json["confirm_payment_intent_client_secret"],
    confirmPaymentIntentId:
      json["confirm_payment_intent_id"] == null
        ? undefined
