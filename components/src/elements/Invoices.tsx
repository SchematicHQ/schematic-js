...
export function Invoices({
  ...
  // Names the table for assistive technology. The heading is a sibling, so
  // nothing associates the two on its own, and a card rendered without a
  // header would otherwise announce as a table of no stated subject.
