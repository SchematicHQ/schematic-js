...
describe("Invoices", () => {
  ...
  test("names the table, with or without a visible header", () => {
    // The heading is a sibling of the table, so nothing associates them on
    ...
    expect(screen.getAllByRole("table", { name: "Invoices" })).toHaveLength(2);
  });
